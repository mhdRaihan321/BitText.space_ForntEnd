    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-[#111115] p-1.5 rounded-xl border border-white/5 inline-flex shadow-lg">
                <Link href="/dashboard/messages/history" className="px-5 py-2.5 rounded-lg text-sm font-medium transition-all flex items-center gap-2 text-gray-400 hover:text-white hover:bg-white/5">
